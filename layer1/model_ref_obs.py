#Architecture and training the model for foreground layer of reflection problem
...
checkpoint = ModelCheckpoint("../../models/obs_ref.hdf5", monitor='loss', verbose=1,save_best_only=True, mode='auto', period=10)
callbacks = [checkpoint]
obs.fit(X_train, y_train, batch_size=50, epochs=20000, validation_data=(X_test, y_test), shuffle=True, callbacks=callbacks)
