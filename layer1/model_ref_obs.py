...
vid2 = np.load('reflection-vid2.npy')
print(inp.shape)
...
obs = load_model("obs_ref.hdf5")
X_train, X_test, y_train, y_test = train_test_split(inp, vid2, test_size=0.2, random_state=42)
print(X_train.shape, y_train.shape)
checkpoint = ModelCheckpoint("obs_ref.hdf5", monitor='loss', verbose=1,save_best_only=True, mode='auto', period=10)
callbacks = [checkpoint]
