...
# inp = cal_cost(mixed)
# np.save('D:/obstruction-mixed.npy', mixed)
# np.save('D:/obstruction-vid1.npy', vid1)
np.save('D:/obstruction-vid2.npy', vid2)
# np.save('D:/obstruction-inp.npy', inp)
